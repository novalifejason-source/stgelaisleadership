  ...
  return (
    <main style={{
      ...
      <div style={{ maxWidth: "480px", margin: "0 auto", padding: "48px 24px", textAlign: "center" }}>
        ...
        <p style={{ fontSize: "16px", color: "#C9A84C", fontWeight: 600, marginBottom: "6px", letterSpacing: "0.03em" }}>
          Leadership Coach · Trainer · Speaker
        </p>
        <p style={{ fontSize: "13px", color: "#8badc9", marginBottom: "28px", letterSpacing: "0.04em" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "12px", maxWidth: "380px", margin: "0 auto" }}>
          ...
          <a href="https://stgelaisleadership.com" style={{
          ...
          <a href="https://youarethegoal.com" style={{
            display: "block", padding: "16px 24px",
            background: "rgba(201,168,76,0.15)",
            color: "#C9A84C", fontWeight: 600, fontSize: "16px",
            textDecoration: "none", borderRadius: "12px",
          ...
          <a href="https://www.linkedin.com/in/jstgelais" style={{
            display: "block", padding: "16px 24px",
            background: "#0077b5",
          ...
          <a href="mailto:jason@stgelaisleadership.com" style={{
            display: "block", padding: "16px 24px",
            background: "rgba(255,255,255,0.06)",
            color: "#f1f5f9", fontWeight: 500, fontSize: "16px",
            textDecoration: "none", borderRadius: "12px",
          ...
          <a href="https://calendly.com/jasonstgelais" target="_blank" rel="noopener noreferrer" style={{
            display: "block", padding: "16px 24px",
            background: "rgba(255,255,255,0.06)",
            color: "#f1f5f9", fontWeight: 500, fontSize: "16px",
            textDecoration: "none", borderRadius: "12px",
          ...
          <a href={VCARD_URL} download="Jason-St-Gelais.vcf" style={{
            display: "block", padding: "16px 24px",
            background: "rgba(255,255,255,0.06)",
            color: "#f1f5f9", fontWeight: 500, fontSize: "16px",
            textDecoration: "none", borderRadius: "12px",
        ...
        <div style={{ marginTop: "40px", padding: "20px", background: "rgba(255,255,255,0.04)", borderRadius: "12px", border: "1px solid rgba(255,255,255,0.08)" }}>
          <p style={{ fontSize: "12px", color: "#8badc9", letterSpacing: "0.06em", textTransform: "uppercase", marginBottom: "8px" }}>Credentials</p>
        ...
        <p style={{ marginTop: "40px", fontSize: "13px", color: "#4a6080" }}>
          Let's connect and explore how we can drive real leadership impact together.
        </p>
      </div>
    </main>
  );
